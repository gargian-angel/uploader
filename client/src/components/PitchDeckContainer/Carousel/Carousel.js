...
//Modified this library - https://github.com/sahilsaha7773/react-carousel-minimal
//Needs to be merged back by making a pull request - Component didn't support mutating image list
export function Carousel({
  ...
  const addSlide = (n) => {
    console.log("In AddSlide n: ", n, " & data.length: ", data.length);
